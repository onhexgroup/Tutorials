...
myfilepath32=r"C:\\Users\\USER\\Desktop\\PE_3\\PE_Sample_32.exe"
myfilepath64=r"C:\\Users\\USER\\Desktop\\PE_3\\PE_Sample_64.exe"

pe = lief.parse(myfilepath64)

## Source: https://github.com/kirschju/richheader/blob/master/prodids.py
int_names = {
...
print("*"*75)
print("Episode 3: Rich Header")
print("*"*75)
rich_headers = pe.rich_header
if rich_headers:
    for entry in rich_headers.entries:
        print(f"  Build ID: {entry.build_id},ProductID: {entry.id} - {vs_version(entry.id)}, Count: {entry.count}")
else:
